    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        <ScrollView style={{width:'100%'}}>
          ...
          <Text
            style={{justifyContent:'center', alignSelf:'center', fontSize:30,color:'green',margin:50}}
            >Registration</Text>
          <TextInput
          ...
          <View style={styles.modalBackButton}>
            ...
            >
            <Text style={{color:'blue'}}>Cancel SignUp</Text>
            </TouchableOpacity>
          </View>
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          ...
          <Text style={{color:'Green'}}>A way of life </Text>
        </View>
        <View style={styles.buttonContainer}>
          ...
          <Text style={{color:'Pink', fontSize:18, fontWeight:'bold',marginLeft:55}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
          ...
          <View style={{alignItems:'center'}}>
            <TouchableOpacity
              ...
              >
              <Text style={{color:'#turqoise', fontSize:18, fontWeight:'bold'}}>LOGIN</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={()=>{
